    ...
    e = (window.Circles = function (t) {
      ...
      if (((this._el = document.getElementById(e)), null !== this._el)) {
        (this._radius = t.radius || 10),
          ...
          (this._styleWrapper = t.styleWrapper === !1 ? !1 : !0),
          (this._styleText = t.styleText === !1 ? !1 : !0);
        var i = (Math.PI / 180) * 270;
        (this._start = (-Math.PI / 180) * 90),
          (this._startPrecise = this._precise(this._start)),
          (this._circ = i - this._start),
  ...
  (e.prototype = {
    ...
    _generateSvg: function () {
      return (
        ...
        this._generatePath(100, !1, this._colors[0])._generatePath(
          1,
          !0,
          this._colors[1]
        ),
    ...
    _generatePath: function (t, e, i) {
      ...
      return (
        ...
        s.setAttribute("stroke", i),
        s.setAttribute("stroke-width", this._strokeWidth),
        s.setAttribute("d", this._calculatePath(t, e)),
    ...
    _arc: function (t, e) {
      ...
      return [
        ...
        s,
        1,
        this._radius + this._radiusAdjusted * Math.cos(i),
        this._radius + this._radiusAdjusted * Math.sin(i),
        e ? "" : "Z",
      ].join(" ");
    },
    _precise: function (t) {
    ...
    htmlifyNumber: function (t, e, i) {
      ...
      return (
        s.length > 1 &&
          (r += '.<span class="' + i + '">' + s[1].substring(0, 2) + "</span>"),
        r
      );
    },
    ...
    update: function (e, i) {
      ...
      var s,
        ...
        _ = 1;
      return (
        (this._value = Math.min(this._maxValue, Math.max(0, e))),
        i
          ? ((s = h.getPercent()),
            (r = s > u),
            (_ += s % 1),
            (n = Math.floor(Math.abs(s - u) / _)),
            (a = i / n),
            (function o(e) {
              if ((r ? (u += _) : (u -= _), (r && u >= s) || (!r && s >= u)))
